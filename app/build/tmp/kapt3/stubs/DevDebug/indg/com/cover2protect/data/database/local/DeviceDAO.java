...
public abstract interface DeviceDAO {
    ...
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM MaisenseDevice WHERE id=:cartItemId")
    ...
    @org.jetbrains.annotations.NotNull()
    @androidx.room.Query(value = "SELECT * FROM MaisenseDevice WHERE synchedid = :synchedid")
    ...
    @androidx.room.Query(value = "SELECT COUNT(*) from MaisenseDevice")
    public abstract int countCartItem();
    
    @androidx.room.Query(value = "DELETE FROM MaisenseDevice")
