...
public final class RegistrationModule_ProvideViewModelFactory
  ...
  public static RegistrationViewModel provideInstance(
      RegistrationModule module,
      Provider<DataManager> dataManagerProvider,
      Provider<ApiService> apiServiceProvider,
      Provider<HeaderData> headerDataProvider) {
  ...
  public static RegistrationModule_ProvideViewModelFactory create(
      ...
      Provider<ApiService> apiServiceProvider,
      Provider<HeaderData> headerDataProvider) {
    return new RegistrationModule_ProvideViewModelFactory(
        module, dataManagerProvider, apiServiceProvider, headerDataProvider);
  }

  public static RegistrationViewModel proxyProvideViewModel(
      RegistrationModule instance,
