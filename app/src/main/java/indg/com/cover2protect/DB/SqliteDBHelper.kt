...
open class DBhelper(context: MedCheckActivity) :
    ...
    override fun onCreate(db: SQLiteDatabase) {
        db.execSQL("CREATE TABLE $TABLE_NAME_BP (ID INTEGER, SYS_mmHg TEXT,DIA_mmHg TEXT,PUL TEXT,IHB TEXT,Date TEXT,UserId TEXT,SystemDate TEXT PRIMARY KEY)")
        db.execSQL("CREATE TABLE $TABLE_NAME_BGM (ID INTEGER, Date TEXT,Mmol TEXT, High TEXT,Low TEXT,Type TEXT,UserId TEXT,SystemDate TEXT PRIMARY KEY)")
    }
