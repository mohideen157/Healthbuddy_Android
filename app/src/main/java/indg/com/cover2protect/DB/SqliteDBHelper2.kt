...
open class DBHelper2(context: Context) :
    ...
    override fun onCreate(db: SQLiteDatabase) {
       db.execSQL("CREATE TABLE $TABLE_NAME_BMI (ID INTEGER, WeigthKg TEXT, BMI TEXT, BodyFat TEXT, MuscleMass TEXT, VisceralFat TEXT, BodyWater TEXT, BoneMass TEXT, BMR TEXT, Target TEXT, ToLose TEXT, DateOfReading TEXT PRIMARY KEY, UserId TEXT)")
    }
